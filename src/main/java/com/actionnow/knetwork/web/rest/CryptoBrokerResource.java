...
/**
 * REST controller for managing {@link com.actionnow.knetwork.domain.CryptoBroker}.
 */
@RestController
...
public class CryptoBrokerResource {
    ...
    public ResponseEntity<CryptoBroker> partialUpdateCryptoBroker(
        ...
        Optional<CryptoBroker> result = cryptoBrokerRepository
            ...
            .map(existingCryptoBroker -> {
                ...
                if (cryptoBroker.getNameEn() != null) {
                    existingCryptoBroker.setNameEn(cryptoBroker.getNameEn());
                }
                ...
                if (cryptoBroker.getDescriptionEn() != null) {
                    existingCryptoBroker.setDescriptionEn(cryptoBroker.getDescriptionEn());
                }
                ...
                if (cryptoBroker.getHeadquartersEn() != null) {
                    existingCryptoBroker.setHeadquartersEn(cryptoBroker.getHeadquartersEn());
                }
                ...
                if (cryptoBroker.getDetailedDescriptionEn() != null) {
                    existingCryptoBroker.setDetailedDescriptionEn(cryptoBroker.getDetailedDescriptionEn());
                }
    ...
    public List<CryptoBroker> getAllCryptoBrokers(
        ...
        if (eagerload) {
            return cryptoBrokerRepository.findAllWithEagerRelationships();
        } else {
    ...
    public ResponseEntity<CryptoBroker> getCryptoBroker(@PathVariable("id") String id) {
        ...
        Optional<CryptoBroker> cryptoBroker = cryptoBrokerRepository.findOneWithEagerRelationships(id);
