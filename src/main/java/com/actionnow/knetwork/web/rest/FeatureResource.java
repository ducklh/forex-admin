...
/**
 * REST controller for managing {@link com.actionnow.knetwork.domain.Feature}.
 */
@RestController
...
public class FeatureResource {
    ...
    public ResponseEntity<Feature> createFeature(@Valid @RequestBody Feature feature) throws URISyntaxException {
        ...
        return ResponseEntity.created(new URI("/api/features/" + feature.getId()))
            .headers(HeaderUtil.createEntityCreationAlert(applicationName, true, ENTITY_NAME, feature.getId()))
            .body(feature);
    }
    ...
    public ResponseEntity<Feature> partialUpdateFeature(
        ...
        Optional<Feature> result = featureRepository
            ...
            .map(existingFeature -> {
                ...
                if (feature.getValueEn() != null) {
                    existingFeature.setValueEn(feature.getValueEn());
                }
