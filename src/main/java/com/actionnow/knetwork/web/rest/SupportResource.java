...
/**
 * REST controller for managing {@link com.actionnow.knetwork.domain.Support}.
 */
@RestController
        ...
        Optional<Support> result = supportRepository
            ...
            .map(existingSupport -> {
                if (support.getValue() != null) {
                    existingSupport.setValue(support.getValue());
                }
                if (support.getValueEn() != null) {
                    existingSupport.setValueEn(support.getValueEn());
                }
