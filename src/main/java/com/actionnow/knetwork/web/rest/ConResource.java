...
/**
 * REST controller for managing {@link com.actionnow.knetwork.domain.Con}.
 */
@RestController
        ...
        Optional<Con> result = conRepository
            ...
            .map(existingCon -> {
                if (con.getValue() != null) {
                    existingCon.setValue(con.getValue());
                }
                if (con.getValueEn() != null) {
                    existingCon.setValueEn(con.getValueEn());
                }
