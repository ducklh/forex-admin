...
/**
 * REST controller for managing {@link com.actionnow.knetwork.domain.PaymentMethod}.
 */
@RestController
        ...
        Optional<PaymentMethod> result = paymentMethodRepository
            ...
            .map(existingPaymentMethod -> {
                if (paymentMethod.getValue() != null) {
                    existingPaymentMethod.setValue(paymentMethod.getValue());
                }
                if (paymentMethod.getValueEn() != null) {
                    existingPaymentMethod.setValueEn(paymentMethod.getValueEn());
                }
