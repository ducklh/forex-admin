...
public class Con implements Serializable {
    ...
    public Con valueEn(String valueEn) {
    ...
    public void setForexBrokers(Set<ForexBroker> forexBrokers) {
        if (this.forexBrokers != null) {
            this.forexBrokers.forEach(i -> i.removeForexCons(this));
        }
        if (forexBrokers != null) {
            forexBrokers.forEach(i -> i.addForexCons(this));
        }
        this.forexBrokers = forexBrokers;
    }

    public Con forexBrokers(Set<ForexBroker> forexBrokers) {
        this.setForexBrokers(forexBrokers);
        return this;
    }

    public Con addForexBrokers(ForexBroker forexBroker) {
        this.forexBrokers.add(forexBroker);
        forexBroker.getForexCons().add(this);
        return this;
    }

    public Con removeForexBrokers(ForexBroker forexBroker) {
        this.forexBrokers.remove(forexBroker);
        forexBroker.getForexCons().remove(this);
        return this;
    }
