...
public class Instrument implements Serializable {
    ...
    public Instrument value(String value) {
        this.setValue(value);
        return this;
    }
    ...
    public Instrument valueEn(String valueEn) {
    ...
    public void setForexBrokers(Set<ForexBroker> forexBrokers) {
        if (this.forexBrokers != null) {
            this.forexBrokers.forEach(i -> i.removeForexInstruments(this));
        }
        if (forexBrokers != null) {
            forexBrokers.forEach(i -> i.addForexInstruments(this));
        }
        this.forexBrokers = forexBrokers;
    }

    public Instrument forexBrokers(Set<ForexBroker> forexBrokers) {
        this.setForexBrokers(forexBrokers);
        return this;
    }

    public Instrument addForexBrokers(ForexBroker forexBroker) {
        this.forexBrokers.add(forexBroker);
        forexBroker.getForexInstruments().add(this);
        return this;
    }

    public Instrument removeForexBrokers(ForexBroker forexBroker) {
        this.forexBrokers.remove(forexBroker);
        forexBroker.getForexInstruments().remove(this);
        return this;
    }
