package com.knetwork.forex.config;

import static org.springframework.security.config.Customizer.withDefaults;

import com.knetwork.forex.security.*;
import com.knetwork.forex.web.filter.SpaWebFilter;
...
public class SecurityConfiguration {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http, MvcRequestMatcher.Builder mvc) throws Exception {
        http
            ...
            .authorizeHttpRequests(authz -> authz.requestMatchers(mvc.pattern("/api/**")).permitAll().anyRequest().permitAll())
