...
import { sampleWithRequiredData } from '../platform.test-samples';
...
describe('Platform Management Component', () => {
  ...
  beforeEach(() => {
    ...
    jest
      ...
      .mockReturnValueOnce(
        of(
          new HttpResponse({
            body: [{ id: '2368b766-4eae-434c-b330-4997a5ab5113' }],
      ...
      .mockReturnValueOnce(
        of(
          new HttpResponse({
            body: [{ id: 'adc9c792-7529-4e73-88ad-9faef0937c79' }],
            headers: new HttpHeaders({
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.platforms()[0]).toEqual(expect.objectContaining({ id: '2368b766-4eae-434c-b330-4997a5ab5113' }));
  });
