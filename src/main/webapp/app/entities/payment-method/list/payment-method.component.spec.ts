...
describe('PaymentMethod Management Component', () => {
  ...
  beforeEach(() => {
    ...
    jest
      ...
      .mockReturnValueOnce(
        of(
          new HttpResponse({
            body: [{ id: 'c956e9ee-89c6-498e-94b9-cc7c3c6dfa79' }],
      ...
      .mockReturnValueOnce(
        of(
          new HttpResponse({
            body: [{ id: '64f1e578-92ea-42c7-871a-a3cd58619324' }],
            headers: new HttpHeaders({
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.paymentMethods()[0]).toEqual(expect.objectContaining({ id: 'c956e9ee-89c6-498e-94b9-cc7c3c6dfa79' }));
  });
