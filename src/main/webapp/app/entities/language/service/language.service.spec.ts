...
import { sampleWithFullData, sampleWithNewData, sampleWithPartialData, sampleWithRequiredData } from '../language.test-samples';
  ...
  describe('Service methods', () => {
    ...
    describe('compareLanguage', () => {
      ...
      it('Should return false if one entity is null', () => {
        const entity1 = { id: 'dfa92605-e7fd-4e21-9d6b-b3a610f8169d' };
        const entity2 = null;
      ...
      it('Should return false if primaryKey differs', () => {
        const entity1 = { id: 'dfa92605-e7fd-4e21-9d6b-b3a610f8169d' };
        const entity2 = { id: '09d6518e-d3f5-4b30-a7cd-112e63d8a292' };
      ...
      it('Should return false if primaryKey matches', () => {
        const entity1 = { id: 'dfa92605-e7fd-4e21-9d6b-b3a610f8169d' };
        const entity2 = { id: 'dfa92605-e7fd-4e21-9d6b-b3a610f8169d' };
