...
export class LanguageComponent implements OnInit {
  ...
  trackId = (item: ILanguage): string => this.languageService.getLanguageIdentifier(item);
      ...
      .pipe(
        ...
        tap(() => {
          if (this.languages().length === 0) {
            ...
            this.languages.set(this.refineData(this.languages()));
          }
        }),
      )
      .subscribe();
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.languages.set(this.refineData(dataFromBody));
  }
