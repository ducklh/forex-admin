...
import regulationResolve from './regulation-routing-resolve.service';

describe('Regulation routing resolve service', () => {
  let mockRouter: Router;
  let mockActivatedRouteSnapshot: ActivatedRouteSnapshot;
  let service: RegulationService;
  let resultRegulation: IRegulation | null | undefined;
  ...
  describe('resolve', () => {
    it('should return IRegulation returned by find', () => {
      ...
      TestBed.runInInjectionContext(() => {
        regulationResolve(mockActivatedRouteSnapshot).subscribe({
          next(result) {
      ...
      expect(resultRegulation).toEqual({ id: 'ABC' });
    });
    ...
    it('should return null if id is not provided', () => {
      ...
      expect(resultRegulation).toEqual(null);
    });

    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse<IRegulation>({ body: null })));
      mockActivatedRouteSnapshot.params = { id: 'ABC' };
