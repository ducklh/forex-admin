...
import { sampleWithFullData, sampleWithNewData, sampleWithPartialData, sampleWithRequiredData } from '../instrument.test-samples';

import { InstrumentService } from './instrument.service';

const requireRestSample: IInstrument = {
  ...
  describe('Service methods', () => {
    ...
    describe('compareInstrument', () => {
      ...
      it('Should return false if one entity is null', () => {
        const entity1 = { id: '28e7708d-b6d7-45a0-9272-8d2777ba9997' };
        const entity2 = null;
      ...
      it('Should return false if primaryKey matches', () => {
        const entity1 = { id: '28e7708d-b6d7-45a0-9272-8d2777ba9997' };
        const entity2 = { id: '28e7708d-b6d7-45a0-9272-8d2777ba9997' };
