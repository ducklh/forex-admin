...
import { sampleWithRequiredData } from '../instrument.test-samples';
...
describe('Instrument Management Component', () => {
  ...
  beforeEach(() => {
    ...
    jest
      ...
      .mockReturnValueOnce(
        of(
          new HttpResponse({
            body: [{ id: '28e7708d-b6d7-45a0-9272-8d2777ba9997' }],
      ...
      .mockReturnValueOnce(
        of(
          new HttpResponse({
            body: [{ id: '9f86699a-96ef-4bc7-a5bc-58e11e0359a6' }],
            headers: new HttpHeaders({
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.instruments()[0]).toEqual(expect.objectContaining({ id: '28e7708d-b6d7-45a0-9272-8d2777ba9997' }));
  });

  describe('trackId', () => {
    it('Should forward to instrumentService', () => {
      const entity = { id: '28e7708d-b6d7-45a0-9272-8d2777ba9997' };
      jest.spyOn(service, 'getInstrumentIdentifier');
      const id = comp.trackId(entity);
      expect(service.getInstrumentIdentifier).toHaveBeenCalledWith(entity);
