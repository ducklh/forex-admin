...
import static com.actionnow.knetwork.domain.SupportAsserts.*;
...
import com.actionnow.knetwork.repository.SupportRepository;
...
class SupportResourceIT {
    ...
    public static Support createEntity() {
        return new Support().value(DEFAULT_VALUE).valueEn(DEFAULT_VALUE_EN);
    }
    ...
    public static Support createUpdatedEntity() {
        return new Support().value(UPDATED_VALUE).valueEn(UPDATED_VALUE_EN);
    }
    ...
    void putExistingSupport() throws Exception {
        ...
        updatedSupport.value(UPDATED_VALUE).valueEn(UPDATED_VALUE_EN);
    ...
    void fullUpdateSupportWithPatch() throws Exception {
        ...
        partialUpdatedSupport.value(UPDATED_VALUE).valueEn(UPDATED_VALUE_EN);
