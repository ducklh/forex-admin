...
import static com.actionnow.knetwork.domain.TagAsserts.*;
...
import com.actionnow.knetwork.repository.TagRepository;
...
class TagResourceIT {
    ...
    public static Tag createEntity() {
        return new Tag().value(DEFAULT_VALUE).valueEn(DEFAULT_VALUE_EN);
    }
    ...
    public static Tag createUpdatedEntity() {
        return new Tag().value(UPDATED_VALUE).valueEn(UPDATED_VALUE_EN);
    }
    ...
    void putExistingTag() throws Exception {
        ...
        updatedTag.value(UPDATED_VALUE).valueEn(UPDATED_VALUE_EN);
    ...
    void partialUpdateTagWithPatch() throws Exception {
        ...
        partialUpdatedTag.valueEn(UPDATED_VALUE_EN);
    ...
    void fullUpdateTagWithPatch() throws Exception {
        ...
        partialUpdatedTag.value(UPDATED_VALUE).valueEn(UPDATED_VALUE_EN);
