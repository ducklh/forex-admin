...
import static com.actionnow.knetwork.domain.ProAsserts.*;
...
class ProResourceIT {
    ...
    public static Pro createEntity() {
        return new Pro().value(DEFAULT_VALUE).valueEn(DEFAULT_VALUE_EN);
    }
    ...
    public static Pro createUpdatedEntity() {
        return new Pro().value(UPDATED_VALUE).valueEn(UPDATED_VALUE_EN);
    }
    ...
    void putExistingPro() throws Exception {
        ...
        updatedPro.value(UPDATED_VALUE).valueEn(UPDATED_VALUE_EN);
    ...
    void fullUpdateProWithPatch() throws Exception {
        ...
        partialUpdatedPro.value(UPDATED_VALUE).valueEn(UPDATED_VALUE_EN);
