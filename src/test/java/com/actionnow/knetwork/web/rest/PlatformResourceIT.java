...
import static com.actionnow.knetwork.domain.PlatformAsserts.*;
...
class PlatformResourceIT {
    ...
    public static Platform createEntity() {
        return new Platform().value(DEFAULT_VALUE).valueEn(DEFAULT_VALUE_EN);
    }
    ...
    public static Platform createUpdatedEntity() {
        return new Platform().value(UPDATED_VALUE).valueEn(UPDATED_VALUE_EN);
    }
    ...
    void putExistingPlatform() throws Exception {
        ...
        updatedPlatform.value(UPDATED_VALUE).valueEn(UPDATED_VALUE_EN);
    ...
    void partialUpdatePlatformWithPatch() throws Exception {
        ...
        partialUpdatedPlatform.valueEn(UPDATED_VALUE_EN);
    ...
    void fullUpdatePlatformWithPatch() throws Exception {
        ...
        partialUpdatedPlatform.value(UPDATED_VALUE).valueEn(UPDATED_VALUE_EN);
