...
import static com.actionnow.knetwork.domain.FeatureAsserts.*;
...
import com.actionnow.knetwork.repository.FeatureRepository;
...
class FeatureResourceIT {
    ...
    public static Feature createEntity() {
        return new Feature().value(DEFAULT_VALUE).valueEn(DEFAULT_VALUE_EN);
    }
    ...
    public static Feature createUpdatedEntity() {
        return new Feature().value(UPDATED_VALUE).valueEn(UPDATED_VALUE_EN);
    }
    ...
    void putExistingFeature() throws Exception {
        ...
        updatedFeature.value(UPDATED_VALUE).valueEn(UPDATED_VALUE_EN);
    ...
    void partialUpdateFeatureWithPatch() throws Exception {
        ...
        partialUpdatedFeature.value(UPDATED_VALUE);
    ...
    void fullUpdateFeatureWithPatch() throws Exception {
        ...
        partialUpdatedFeature.value(UPDATED_VALUE).valueEn(UPDATED_VALUE_EN);
