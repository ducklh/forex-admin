...
import static com.knetwork.forex.domain.ConAsserts.*;
...
class ConResourceIT {
    ...
    public static Con createEntity() {
        return new Con().text(DEFAULT_TEXT);
    }
    ...
    public static Con createUpdatedEntity() {
        return new Con().text(UPDATED_TEXT);
    }
    ...
    void fullUpdateConWithPatch() throws Exception {
        ...
        partialUpdatedCon.text(UPDATED_TEXT);
