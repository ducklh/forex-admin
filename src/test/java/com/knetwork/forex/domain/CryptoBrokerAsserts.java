...
public class CryptoBrokerAsserts {
    ...
    public static void assertCryptoBrokerUpdatableFieldsEquals(CryptoBroker expected, CryptoBroker actual) {
        assertThat(actual)
            ...
            .satisfies(a -> assertThat(a.getPros()).as("check pros").isEqualTo(expected.getPros()))
            .satisfies(a -> assertThat(a.getCons()).as("check cons").isEqualTo(expected.getCons()))
            ...
            .satisfies(a -> assertThat(a.getCustomerSupport()).as("check customerSupport").isEqualTo(expected.getCustomerSupport()))
